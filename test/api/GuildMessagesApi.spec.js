...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloneCordApi.GuildMessagesApi();
  });

  describe('(package)', function() {
    describe('GuildMessagesApi', function() {
      ...
      describe('sendMessageUsingPOST', function() {
        it('should call sendMessageUsingPOST successfully', function(done) {
          ...
          var channelId = "channelId_example";
          var guildId = "guildId_example";
          var message = new CloneCordApi.FormMessage();
          message.message = "";

          instance.sendMessageUsingPOST(channelId, guildId, message, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
