...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloneCordApi.UsersAPIApi();
  });

  describe('(package)', function() {
    describe('UsersAPIApi', function() {
      describe('getSelfGuildsUsingGET', function() {
        it('should call getSelfGuildsUsingGET successfully', function(done) {
          // TODO: uncomment getSelfGuildsUsingGET call and complete the assertions
          /*

          instance.getSelfGuildsUsingGET(function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('getSelfUsingGET', function() {
        it('should call getSelfUsingGET successfully', function(done) {
          // TODO: uncomment getSelfUsingGET call and complete the assertions
          /*

          instance.getSelfUsingGET(function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('getUserUsingGET', function() {
        it('should call getUserUsingGET successfully', function(done) {
          ...
          instance.getUserUsingGET(userId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('putSelfUsingPUT', function() {
        it('should call putSelfUsingPUT successfully', function(done) {
          // TODO: uncomment, update parameter values for putSelfUsingPUT call and complete the assertions
          /*
          var opts = {};
          opts.user = new CloneCordApi.FormUser();
          opts.user.avatar = "";
          opts.user.username = "";

          instance.putSelfUsingPUT(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
