...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloneCordApi.AuthenticationAPIApi();
  });

  describe('(package)', function() {
    describe('AuthenticationAPIApi', function() {
      describe('loginUsingPOST', function() {
        it('should call loginUsingPOST successfully', function(done) {
          ...
          /*
          var opts = {};
          opts.user = new CloneCordApi.FormLogin();
          opts.user.email = "";
          opts.user.password = "";

          instance.loginUsingPOST(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('signUpUsingPOST', function() {
        it('should call signUpUsingPOST successfully', function(done) {
          ...
          /*
          var opts = {};
          opts.registrationData = new CloneCordApi.RegistrationUser();
          opts.registrationData.email = "";
          opts.registrationData.password = "";
          opts.registrationData.username = "";

          instance.signUpUsingPOST(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
