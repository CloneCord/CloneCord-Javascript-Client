...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CloneCordApi.ChannelsAPIApi = factory(root.CloneCordApi.ApiClient, root.CloneCordApi.Channel, root.CloneCordApi.FormChannel);
  }
  ...
  /**
   * ChannelsAPI service.
   * @module api/ChannelsAPIApi
   * @version 1.0
   */

  /**
   * Constructs a new ChannelsAPIApi. 
   * @alias module:api/ChannelsAPIApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/ChannelsAPIApi~createChannelUsingPOSTCallback
     ...
     * @param {module:api/ChannelsAPIApi~createChannelUsingPOSTCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/ChannelsAPIApi~deleteChannelUsingDELETECallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} guildId ID of the specified Guild
     * @param {module:api/ChannelsAPIApi~deleteChannelUsingDELETECallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/ChannelsAPIApi~updateChannelUsingPUTCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Channel} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/ChannelsAPIApi~updateChannelUsingPUTCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Channel}
     */
