...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CloneCordApi.GuildsAPIApi = factory(root.CloneCordApi.ApiClient, root.CloneCordApi.FormGuild, root.CloneCordApi.Guild);
  }
  ...
  /**
   * GuildsAPI service.
   * @module api/GuildsAPIApi
   * @version 1.0
   */

  /**
   * Constructs a new GuildsAPIApi. 
   * @alias module:api/GuildsAPIApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/GuildsAPIApi~createGuildUsingPOSTCallback
     ...
     * @param {module:api/GuildsAPIApi~createGuildUsingPOSTCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/GuildsAPIApi~deleteGuildUsingDELETECallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/GuildsAPIApi~deleteGuildUsingDELETECallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/GuildsAPIApi~getGuildInfoUsingGETCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Guild} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} guildId ID of the specified Guild
     * @param {module:api/GuildsAPIApi~getGuildInfoUsingGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Guild}
     */
     ...
     * @callback module:api/GuildsAPIApi~updateGuildUsingPUTCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Guild} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/GuildsAPIApi~updateGuildUsingPUTCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Guild}
     */
