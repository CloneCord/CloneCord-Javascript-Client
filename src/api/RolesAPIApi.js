...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CloneCordApi.RolesAPIApi = factory(root.CloneCordApi.ApiClient, root.CloneCordApi.FormRole, root.CloneCordApi.Role);
  }
  ...
  /**
   * RolesAPI service.
   * @module api/RolesAPIApi
   * @version 1.0
   */

  /**
   * Constructs a new RolesAPIApi. 
   * @alias module:api/RolesAPIApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/RolesAPIApi~createRoleUsingPOSTCallback
     ...
     * @param {module:api/RolesAPIApi~createRoleUsingPOSTCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/RolesAPIApi~deleteRoleUsingDELETECallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/RolesAPIApi~deleteRoleUsingDELETECallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/RolesAPIApi~updateRoleUsingPUTCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Role} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/RolesAPIApi~updateRoleUsingPUTCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Role}
     */
