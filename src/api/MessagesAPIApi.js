...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CloneCordApi.MessagesAPIApi = factory(root.CloneCordApi.ApiClient, root.CloneCordApi.FormMessage, root.CloneCordApi.Message);
  }
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/MessagesAPIApi~deleteMessageUsingDELETECallback
     ...
     * @param {module:api/MessagesAPIApi~deleteMessageUsingDELETECallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/MessagesAPIApi~getMessagesUsingGETCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/MessagesAPIApi~getMessagesUsingGETCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/MessagesAPIApi~sendMessageUsingPOSTCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/MessagesAPIApi~sendMessageUsingPOSTCallback} callback The callback function, accepting three arguments: error, data, response
